...
const int num_ants = 8; // Number of ants
    ...
    std::vector<int> find_best_tour() {
        ...
        #pragma omp parallel
        {
            ...
            for (int i = 0; i < num_ants; ++i) {
                ...
                #pragma omp critical
                {
                    if (tour_distance < local_best_distance) {
                        local_best_distance = tour_distance;
            ...
            #pragma omp critical
            {
                ...
                // Update pheromones based on the best tour
                update_pheromones(best_tour, best_distance);
            }
        }
...
int main() {
    ...
    int num_nodes = 100;
    int num_threads = 2; // Change the number of threads here
    ...
    // Print the runtime
    std::cout << "Runtime: " << end_time - start_time << " seconds\n";
